...
const packages = [
  {
    name: 'Starter',
    description: 'Perfekt für den Einstieg in die Automatisierung',
    price: '490',
    features: [
      { name: '1 einfacher Workflow', included: true },
      { name: 'Formular → E-Mail/Sheet', included: true },
      { name: 'Einmalige Einrichtung', included: true },
  ...
  {
    name: 'Smart Business',
    description: 'Mehrere Automatisierungen inkl. KI-Integration',
    price: '990',
    features: [
      { name: '2–3 Automationen', included: true },
      { name: 'GPT-Integration', included: true },
      { name: 'Chatbot oder Telegram-Bot', included: true },
  ...
  },
  {
    ...
    description: 'Individuelle Lösung für komplexe Anforderungen',
    price: 'Individuell',
    features: [
      { name: 'Individuelle Lösung', included: true },
      { name: 'Onboarding & Training', included: true },
      { name: 'Monitoring-Dashboard', included: true },
      { name: 'Prioritätssupport', included: true },
    ],
    popular: false,
  },
]
