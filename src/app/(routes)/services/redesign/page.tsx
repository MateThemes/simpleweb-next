...
import { BrushIcon, CheckIcon } from '@/components/icons'

export const metadata: Metadata = {
  title: 'Website Redesign Service | SimpleWeb',
  description: 'Professionelles Website Redesign für einen modernen und erfolgreichen Webauftritt. Nutzen Sie die Chancen der Digitalisierung mit einem zeitgemäßen Design.',
}
          ...
          <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 sm:mt-20 lg:max-w-none lg:grid-cols-2">
            {features.map((feature, index) => (
              <div key={index} className="flex gap-6 rounded-2xl bg-white dark:bg-neutral-800 p-8 shadow-sm">
                <BrushIcon className="h-8 w-8 text-purple-600 flex-shrink-0" />
                <div>
