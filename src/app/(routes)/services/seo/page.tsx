...
import { ChartArrowsVerticalIcon, CheckIcon } from '@/components/icons'

export const metadata: Metadata = {
  title: 'SEO-Optimierung Service | SimpleWeb',
  description: 'Professionelle SEO-Optimierung für bessere Sichtbarkeit in Suchmaschinen. Steigern Sie Ihren organischen Traffic mit modernsten SEO-Techniken.',
}
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-8 -left-8">
                  <div className="bg-green-600 rounded-xl shadow-lg p-6 text-white">
                    <ChartArrowsVerticalIcon className="h-8 w-8 mb-2" />
          ...
          <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 sm:mt-20 lg:max-w-none lg:grid-cols-2">
            {features.map((feature, index) => (
              <div key={index} className="flex gap-6 rounded-2xl bg-white dark:bg-neutral-800 p-8 shadow-sm">
                <ChartArrowsVerticalIcon className="h-8 w-8 text-green-600 flex-shrink-0" />
                <div>
