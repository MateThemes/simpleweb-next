...
export const metadata: Metadata = {
  title: 'Über SimpleWeb | Ihre Webdesign Agentur',
  description: 'Lernen Sie mich kennen - Ihr erfahrener Partner für Webdesign, SEO und Online Marketing in Deutschland.',
}
        ...
        <div className="relative overflow-hidden bg-neutral-50 dark:bg-neutral-900 rounded-3xl px-6 py-20 sm:px-12 sm:py-28">
          ...
          <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            <div className="flex flex-col rounded-3xl bg-white dark:bg-neutral-800 px-6 py-8">
              ...
              <Image
                src="/images/services/webdesign-icon.jpg"
            ...
            <div className="flex flex-col rounded-3xl bg-white dark:bg-neutral-800 px-6 py-8">
              ...
              <Image
                src="/images/services/ecommerce-icon.jpg"
