...
export const metadata: Metadata = {
  title: "Webdesign Preise & Pakete für KMU | AT & DE",
  description:
    "Webdesign Preise & Pakete für KMU in Österreich und Deutschland. Transparente Investitionen, klare Struktur und messbare Wirkung. Jetzt kostenlose Analyse sichern.",
  openGraph: {
    title: "Webdesign Preise & Pakete für KMU | AT & DE | SimpleWebDesign",
    description:
      "Webdesign Preise & Pakete für KMU in Österreich und Deutschland. Transparente Investitionen, klare Struktur und messbare Wirkung. Jetzt kostenlose Analyse sichern.",
...
const websitePackages = [
  {
    name: "Standard",
    description:
      "Solider Einstieg mit klarer Struktur und professioneller Basis.",
  ...
  {
    name: "Premium",
    description: "Mehr Struktur, bessere Sichtbarkeit, stärkere Wirkung.",
  ...
  {
    name: "Komplett",
    description: "Strategische Weiterentwicklung statt einmaliger Umsetzung.",
    valueLine: "Maximale Wirkung mit laufender Betreuung.",
    price: "4.990",
    features: [
...
const redesignPackages = [
  {
    ...
    description:
      "Klarer, schneller, wirkungsvoller. Ohne Inhalte neu erfinden zu müssen.",
  ...
  },
  {
    ...
    description: "Kontinuierliche Optimierung und laufende Wartung.",
...
const kiPackages = [
  ...
  },
  {
    name: "KI Advanced",
    description:
      "Mehrstufige Automatisierungen mit Workflow-Management – für komplexere Prozesse.",
    valueLine: "Für komplexere Abläufe und skalierbare Prozesse.",
    price: "1.290",
    features: [
  ...
  },
  {
    ...
    description:
      "Individuelle KI-Lösungen mit Schulung – für anspruchsvolle Automatisierungsprojekte.",
      ...
      <main className="flex-auto">
        ...
        >
          <Container className="relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                Transparente Investitionen in Webdesign & KI-Automatisierung
              </h1>
              <p className="mt-6 text-xl text-[var(--muted-foreground)] max-w-3xl mx-auto leading-relaxed">
                Von der Website-Erstellung bis zur intelligenten
                Prozessautomatisierung – alle Leistungen für KMU aus einer Hand,
                klar kalkuliert und DSGVO-konform.
              </p>
              <div className="mt-8">
                <Link
                  href="/kontakt"
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-x-4 gap-y-1 text-sm text-[var(--muted-foreground)]">
                <Link
                  ...
                  className="hover:text-[var(--foreground)] underline underline-offset-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)] focus-visible:ring-offset-2 rounded"
                >
                  Webdesign-Services
                </Link>
        ...
        <PricingSection id="webdesign-pakete" variant="surface-2">
          ...
          <p className="mt-10 text-center text-sm text-[var(--muted-foreground)]">
            Optional: kombinierbar mit KI-Automatisierung von Anfragen oder
            Formularprozessen.
          </p>
        </PricingSection>
        ...
        <PricingSection id="redesign-pakete" variant="background">
          ...
          <p className="mt-10 text-center text-sm text-[var(--muted-foreground)]">
            Optional: kombinierbar mit KI-Automatisierung – z. B. für Kontakt-
            oder Anfrageprozesse.
          </p>
        </PricingSection>

        {/* KI-Automatisierung */}
        <PricingSection id="ki" variant="surface-2">
          <PricingSectionHeader
        ...
        <ServiceCardGrid
          ...
          description="Für Projekte mit erweiterten Anforderungen bieten wir flexible Zusatzleistungen."
          cards={serviceCards}
