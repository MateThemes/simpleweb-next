export function DeviceLaptopIcon({ className }: { className?: string }) {
  return (
    <svg
...
export function ChartArrowsVerticalIcon({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
...
export function ChartDotsIcon({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
...
export function RouteIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M17 3l4 4" />
      <path d="M21 3l-4 4" />
      <path d="M12 21v-9a4 4 0 0 0 -4 -4h-4" />
      <path d="M16 3v4h4" />
    </svg>
  )
}
...
export function DeviceMobileIcon({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
...
export function PaletteIcon({ className }: { className?: string }) {
  return (
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
      <path d="M12 21a9.004 9.004 0 0 0 2.32 -.302a9 9 0 0 0 1.74 -16.733a9 9 0 0 0 -11.082 0a9 9 0 0 0 -1.988 16.793a9 9 0 0 0 8.008 0" />
      <path d="M9 7.5c.553 0 1 .895 1 2s-.447 2 -1 2s-1 -.895 -1 -2s.447 -2 1 -2z" />
      <path d="M15 7.5c.553 0 1 .895 1 2s-.447 2 -1 2s-1 -.895 -1 -2s.447 -2 1 -2z" />
      <path d="M12 12c.553 0 1 .895 1 2s-.447 2 -1 2s-1 -.895 -1 -2s.447 -2 1 -2z" />
    </svg>
  )
}
...
export function UserGroupIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M3 13h2a2 2 0 0 1 2 2v1" />
    </svg>
  )
}
...
export function SunIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M3 12h1m8 -9v1m8 8h1m-15.4 -6.4l.7 .7m12.1 -.7l-.7 .7m-12.1 12.1l.7 .7m12.1 -.7l-.7 .7" />
    </svg>
  )
}
...
export function SparklesIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M6 9a6 6 0 0 1 6 -6a6 6 0 0 1 6 6a6 6 0 0 1 -6 6a6 6 0 0 1 -6 -6z" />
      <path d="M6 9a2 2 0 0 1 2 -2a2 2 0 0 1 2 2a2 2 0 0 1 -2 2a2 2 0 0 1 -2 -2z" />
    </svg>
  )
}
...
export function CodeBracketIcon({ className }: { className?: string }) {
  return (
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
      <path d="M8 3l-4 8l4 8" />
      <path d="M16 21l4 -8l-4 -8" />
      <path d="M12 3l0 18" />
    </svg>
  )
}
