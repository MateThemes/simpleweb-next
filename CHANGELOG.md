...
#### Build Optimization
- **Configured modern browser targets** to reduce polyfills
- **Updated browserslist** to exclude IE 11 and dead browsers
...
- `next.config.ts` - Added SWC minification and package optimization
- `package.json` - Updated browserslist to exclude IE 11 and dead browsers
